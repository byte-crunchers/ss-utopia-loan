...
public class H2DataBootstrap implements CommandLineRunner {
    ...
    private void loadAllLoan(){
        ...
        var User1 = User.builder()
                ...
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .street_address("Ap #705-3955 Ultricies St.")
                .permissions("")
                .build();
        userRepository.save(User1);
        ...
        var User4 = User.builder()
                ...
                .email("smoothstack@email.com")
                .is_admin(false)
                .street_address("491-6511 Aliquet Rd.")
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .permissions("")
                .build();
        ...
        var User5 = User.builder()
                ...
                .email("smoothstack@email.com")
                .is_admin(false)
                .street_address("Ap #573-3947 Donec Ave")
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .permissions("")
                .build();
        ...
        var User6 = User.builder()
                ...
                .email("smoothstack@email.com")
                .is_admin(false)
                .street_address("Ap #627-639 Non, Street")
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .permissions("")
                .build();
        ...
        var User7 = User.builder()
                ...
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .street_address("P.O. Box 749, 1638 Vel, Rd.")
                .permissions("")
                .build();
        ...
        var User8 = User.builder()
                ...
                .email("smoothstack@email.com")
                .is_admin(false)
                .street_address("Ap #157-9547 Diam St.")
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .permissions("")
                .build();
        ...
        var User9 = User.builder()
                ...
                .email("smoothstack@email.com")
                .is_admin(false)
                .street_address("889-7883 Ut Road")
                .password(passwordEncoder.encode("dan123"))
                .roles("USER")
                .permissions("")
                .build();
